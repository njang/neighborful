...
from .views import index, about, show, profile, sell_form, edit_form, post_produce, marketplace, login_view, logout_view
...
urlpatterns = [
    ...
    url(r'^edit/([0-9]+)/post_url/$', edit_form, name='edit'),  # display a single produce by id
